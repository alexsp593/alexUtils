...
import com.alex.config.AlexConfig;
...
/**
 * @Deception:封装Email相关的操作
 * @Author:Alex
 * @Date:2018年06月10日15点56分
 */
public final class EmailUtils {
     ...
     * 初始化方法
     */
    public EmailUtils(boolean debug) {

        this.mailHost = AlexConfig.get("mail.smtp.host");
        this.port = Integer.valueOf(AlexConfig.get("mail.smtp.port"));
        this.auth = Boolean.parseBoolean(AlexConfig.get("mail.smtp.auth"));
        this.sender_username = AlexConfig.get("mail.sender.username");
        this.sender_password = AlexConfig.get("mail.sender.password");
