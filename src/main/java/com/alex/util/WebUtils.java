...
/**
 * @Deception:提供Web相关的个工具类
 * @Author:Alex
 * @Date:2018年06月14日10点27分
 */
public final class WebUtils {
    ...
    public static String escape(String str, String encoding) throws UnsupportedEncodingException {
        ...
        char[] chars = ConvertUtils.bytesToChars(ConvertUtils.encodeBytes(str.getBytes(encoding), '%'));
    ...
    public static String unescape(String str,String encoding){
        ...
        return UrlUtils.decodeQuery(str, encoding);
    }
