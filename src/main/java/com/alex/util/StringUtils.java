...
import com.alex.util.file.BCConvert;
import com.alex.util.file.StringImpl;
...
/**
 * @Deception:提供些常用的字符串相关的工具方法
 * @Author:Alex
 * @Date:2018年06月09日14点17分
 */
public final class StringUtils {
    ...
    public  static String joinString(String[] array, String symbol) {
        ...
        if (array != null) {
            ...
            if (result.length() > 1 && CheckUtils.valid(symbol)) {
    ...
    public  static String join(String linkStr,String ... strs){
        ...
        if (result.length() > 1 && CheckUtils.valid(linkStr)) {
    ...
    public  static boolean isIn(String substring, String[] source) {
        if(isEmpty(substring) || !CheckUtils.valid(source)){
            return false;
        }
        for (String t:source) {
    ...
    public  static double SimilarityRatio(String str1, String str2) {
        str1 = StringUtils.trimPunct(str1);
        str2 = StringUtils.trimPunct(str2);
