...
import com.alex.util.SysUtils;

import java.io.UnsupportedEncodingException;

/**
 * @Deception:对比俩个字符串的相似度
 * @Author:Alex
 * @Date:2018年06月09日14点18分
 */
public class StringImpl {
    ...
    public static String simpleEncoding(String str) {
        try{
            byte[] bs = str.getBytes(SysUtils.JVM_ENCODING);
            if(str.equals(new String(bs, CharsetUtils.UTF_8))){
                return CharsetUtils.UTF_8;
            }
            if(str.equals(new String(bs, CharsetUtils.GBK))){
